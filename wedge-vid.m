...
outputVideo.FrameRate = 2; % Set the frame rate of the MP4
open(outputVideo);
...
for theta = 0.1:0.005:0.4 % 劈尖夹角
    ...
    writeVideo(outputVideo, m(:, times).cdata);
end

% Close the MP4 file
close(outputVideo);

% Display a message indicating that the MP4 has been saved
disp(['MP4 saved as ' outputFileName]);
